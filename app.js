document.addEventListener("DOMContentLoaded", () => {
  ...
  const accordionOne = new ExpandableElement(titleOne, textOne);
  const accordionTwo = new ExpandableElement(titleTwo, textTwo);
  accordionOne.mount("wrapper");
  accordionTwo.mount("wrapper");
